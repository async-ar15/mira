...
# scripts/deploy.sh
#
# Deployment verification script for mira on Railway.
#
# WHAT THIS DOES:
...
export GOOGLE_API_KEY="${GOOGLE_API_KEY:-sk-test-placeholder}"
export GOOGLE_EMBEDDING_MODEL="text-embedding-004"
export SECURITY_MODEL="gemini-3.1-pro-preview"
